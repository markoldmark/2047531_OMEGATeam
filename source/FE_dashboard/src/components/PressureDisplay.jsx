...
const PressureDisplay = ({ value = 0, label = "press" }) => {
  return (
    <div className="flex flex-col items-center scale-75">
      {/* Sostituito w-30 (non valido) con w-32 e h-[10%] con h-16 (altezza fissa affidabile) */}
      <div className="w-40 h-16 bg-slate-900/80 rounded-2xl border scale-75 border-white/10 shadow-[inset_0_0_20px_rgba(0,0,0,0.8)] flex items-center justify-center relative overflow-hidden backdrop-blur-md">
      ...
      <div className="mt-2 text-xs font-semibold text-slate-400 uppercase tracking-widest -mt-1">
        {label}
      </div>
    </div>
  );
